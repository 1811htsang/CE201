...
- [ ] Review lại tài liệu liên quan đến repo Predictive Maintenance sẵn có. //NOTE - Thực hiện việc kiểm tra lại các tính năng, tài liệu, thiết kế hardware.
- [ ] Revert lại các porting MCU trước đó, tập trung vào STM32H723, ESP32S3. // NOTE - Phần này sẽ để Minh thực hiện tìm lại.
...
- [ ] Viết đề cương theo khung Mục 7 (đặc biệt Chương 1 & 4) để GV duyệt trước khi code phần AI.
